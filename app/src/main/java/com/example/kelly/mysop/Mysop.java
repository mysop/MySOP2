...
public class Mysop extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picture=(ImageView)findViewById(R.id.list_picture);
        title=(TextView)findViewById(R.id.list_title);
        master=(TextView)findViewById(R.id.list_master);
        icon=(ImageView)findViewById(R.id.initiate_icon);
...
/*            runOnUiThread(new Runnable() {
            ...
            title.setText(TAG_PRODUCTS);
            master.setText(TAG_NAME);
